...
import com.zxm.coding.asm_lifecycle_plugin.LifecycleClassVisitor
            ...
            transformInput.directoryInputs.each { DirectoryInput directoryInput ->
                ...
                if (dir) {
                    dir.traverse(type: FileType.FILES, nameFilter: ~/.*\.class/) { File file ->
                        System.out.println("1.==> find class: " + file.name)
                        //对class文件进行读取与解析
                        ...
                        // new FileOutputStream( file.parentFile.absolutePath + File.separator + fileName)
